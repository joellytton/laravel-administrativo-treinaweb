                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($movimentoFinanceiro as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/movimentos_financeiros/' . $item->id) }}" title="Detalhes Movimentos_financeiro"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Detalhes</button></a>
                                            <a href="{{ url('/movimentos_financeiros/' . $item->id . '/edit') }}" title="Atualizar Movimentos_financeiro"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Atualizar</button></a>
                            ...
                            <div class="pagination-wrapper"> {!! $movimentoFinanceiro->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>

...
@section('title')
    <h1>Novo Movimentos Financeiro</h1>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/movimentos_financeiros/create') }}">Novo Movimentos Financeiro</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Novo Movimentos Financeiro</div>
                    <div class="card-body">

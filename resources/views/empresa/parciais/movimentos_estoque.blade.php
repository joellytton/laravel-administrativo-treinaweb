                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST"
                                    action="{{ route('movimentos_estoque.destroy', $movimentoEstoque) }}"
                                    accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
                                    <button type="submit" class="btn btn-danger btn-sm" title="Apagar Movimento"
                                        onclick="return confirm(&quot;Tem certeza que deseja apagar esse movimento?&quot;)"><i
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select id="produto-ajax" name="produto_id" type="text" class="form-control"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group pt-2">
                            ...
                            <div class="input-group">
                                <button class="btn btn-info m-t-xs" title=""><i class="fa fa-plus"

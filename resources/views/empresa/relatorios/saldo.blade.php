                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="data_inicio" name="data_inicial" type="text"
                                            class="form-control date" value="{{ request('data_inicial') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="data_final" name="data_final" type="text" class="form-control date"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group pt-2">
                                    ...
                                    <div class="input-group">
                                        <button class="btn btn-info m-t-xs" title="Buscar Conta"><i class="fa fa-search"
